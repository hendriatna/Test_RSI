...
<body id="body">
  ...
  <header id="header">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="#body"><img id="logoUlung" src="<?php echo base_url('assets/img/si-ulungIT-fix.png');?>" alt="" title=""/>-<span>Ulung</span>IT</a></h1>
      </div>
      ...
      <ul>
        ...
        <li><a href="#">JavaScript</a></li>
          ...
          <li><a href="<?php echo site_url('berita_main');?>"">Berita</a></li>
  ...
  <nav>
    <ul>
      <li id="menuSisi" class="active">Ekonomi</li>
      ...
      <br>
      <li id="menuSisi" class="active">Sosial</li>
      <li id="menuSisi"><a href="#">Mengenal MVC</a></li>
      <li id="menuSisi"><a href="#">Framework di Java</a></li>
      <br>
      <li id="menuSisi" class="active">Pemerintah</li>
      <li id="menuSisi"><a href="#">Mengenal MVC</a></li>
      <li id="menuSisi"><a href="#">Framework di Java</a></li>
      <li id="menuSisi"><a href="#">Belajar JSP</a></li>      
      <br>
      <li id="menuSisi" class="active">Olah Raga</li>
      <li id="menuSisi"><a href="#">Mengenal MVC</a></li>
      <li id="menuSisi"><a href="#">Framework di Java</a></li>
      <li id="menuSisi"><a href="#">Belajar JSP</a></li>
      <br>
      <li id="menuSisi" class="active">Infotainment</li>
      <li id="menuSisi"><a href="#">Mengenal MVC</a></li>
      <li id="menuSisi"><a href="#">Framework di Java</a></li>
      <li id="menuSisi"><a href="#">Belajar JSP</a></li>
      <li id="menuSisi"><a href="#">Belajar JSP</a></li>
...
<section class="main">
  <br/>
  <h2>Beranda Berita</h2>
  <p>Menginformasikan berita terupdate, aktual, dan terpercaya yang ada di sekitar kita.</p>
</section>
