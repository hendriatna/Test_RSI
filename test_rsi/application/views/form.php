  ...
  <main id="main">
      ...
      <div class="container">
        ...
        <hr>  
          ...
          <form action="<?php echo site_url('save_employee') ?>" method="post" role="form">
            <div class="form-group form-row">
                <label for="nama" class="col-sm-2 col-form-label">Nama*</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control <?php echo form_error('nama') ? 'is-invalid':'' ?>" name="nama" id="nama" placeholder="Nama"/>
            ...
            <div class="form-group form-row">
                ...
                <div class="col-sm-10">
                <input type="text" class="form-control  <?php echo form_error('nama') ? 'is-invalid':'' ?>" name="nama_alias" id="nama_alias" placeholder="Nama Alias" />
                <div class="invalid-feedback">
            ...
            <div class="form-group form-row">
                ...
                <div class="col-sm-10">
                  <textarea class="form-control <?php echo form_error('alamat') ? 'is-invalid':'' ?>" name="alamat" id="alamat" placeholder="Alamat" ></textarea>
                  <div class="invalid-feedback">
            ...
            <div class="form-group form-row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control <?php echo form_error('email') ? 'is-invalid':'' ?>" name="email" id="email" placeholder="Email"/>
                  <div class="invalid-feedback">
            ...
            <div class="form-group form-row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control <?php echo form_error('telepon') ? 'is-invalid':'' ?>" name="telepon" id="telepon" placeholder="Telepon"/>
                  <div class="invalid-feedback">
