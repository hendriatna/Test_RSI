...
<body id="body">
    ...
    <div class="container">
      ...
      <ul>
        ...
        <li><a href="#">JavaScript</a></li>
          ...
          <li><a href="#" onClick="berita()">Berita</a></li>
  ...
  <nav>
    <ul>
      ...
      <li id="menuSisi">Kenalan dengan Java</li>
...
<section class="main">
  <br/>
  <h2>Pengenalan Java</h2>
  <p>Java adalah bahasa pemrogramman tingkat tinggi yang open source.</p>
</section>
